...
import Blockly from "../utils/blockly_shims";
import { BlockMirrorTextToBlocks } from "../utils/textToBlocks";
import { BlockMirrorBlockEditor } from "../utils/blockEditor";
...
const Toolbar = () => {
  ...
  BlockMirrorTextToBlocks.prototype.getBuiltinAnnotation = function (
    annotation
  ) {
  ...
  Blockly.Blocks["ast_Call"] = {
    ...
    domToMutation: function domToMutation(xmlElement) {
      ...
      this.showParameterNames_ =
        "true" === xmlElement.getAttribute("parameters");
  ...
  Blockly.Blocks["ast_FunctionDef"] = {
     ...
     */
    domToMutation: function domToMutation(xmlElement) {
      this.decoratorsCount_ = parseInt(
        xmlElement.getAttribute("decorators"),
        10
      );
      this.parametersCount_ = parseInt(
  ...
  BlockMirrorTextToBlocks.prototype["ast_FunctionDef"] = function (
    node,
    parent
  ) {
    var name = node.name;
  ...
  Blockly.Blocks["ast_Lambda"] = {
    ...
    setReturnAnnotation_:
      Blockly.Blocks["ast_FunctionDef"].setReturnAnnotation_,
  };
  ...
  BlockMirrorTextToBlocks.prototype["ast_ClassDef"] = function (node, parent) {
    ...
    if (keywords !== null) {
      for (var _i14 = 0; _i14 < keywords.length; _i14++) {
        values["KEYWORDVALUE" + _i14] = this.convert(
          keywords[_i14].value,
          node
        );
