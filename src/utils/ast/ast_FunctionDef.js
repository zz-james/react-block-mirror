export const add_ast_FunctionDef = ([Blockly, BlockMirrorTextToBlocks]) => {
  ...
  [
    ...
    Blockly.Python["ast_Function" + parameterType] = function (block) {
      let name = Blockly.Python.variableDB_.getName(
    ...
    compose: function (containerBlock) {
      ...
      for (let i = 0; i < this.parametersCount_; i++) {
        ...
        if (!connections[i]) {
          let createName =
            "ast_Function" +
            blockTypes[i].substring("ast_FunctionMutant".length);
